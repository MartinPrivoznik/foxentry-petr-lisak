 ...
 */
export const handleCascadeDeletePriceHistory = async function(this: Query<unknown, IProduct>) {
    if(!this) return;
...
export const handleAddProductPriceUpdate = async function(this: Query<unknown, IProduct>) {
    if(!this) return;
}